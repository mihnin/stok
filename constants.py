...
AGING_SCALE_METHOD_1 = [
    ...
    {"name": "1-3 мес.", "min_days": 31, "max_days": 91, "status": "Ликвидный"},
    {"name": "3-6 мес.", "min_days": 92, "max_days": 183, "status": "Ликвидный"},
    {"name": "6-9 мес.", "min_days": 184, "max_days": 274, "status": "Ликвидный"},
    {"name": "9-12 мес.", "min_days": 275, "max_days": 365, "status": "КСНЗ"},
    {"name": "12-18 мес.", "min_days": 366, "max_days": 548, "status": "СНЗ"},
    {"name": "18-24 мес.", "min_days": 549, "max_days": 730, "status": "СНЗ"},
...
AGING_SCALE_METHOD_2 = [
    ...
    {"name": "12-18 мес.", "min_days": 365, "max_days": 547, "status": "СНЗ"},
    {"name": "18-24 мес.", "min_days": 548, "max_days": 1095, "status": "СНЗ"},
    # "Без даты" должно иметь приоритет над "> 3 лет"
    {
        "name": "Без даты",
        "min_days": 10000,
        "max_days": 10000,
    ...
    {"name": "> 3 лет", "min_days": 1096, "max_days": 99999, "status": "СНЗ > 3 лет"},
]
